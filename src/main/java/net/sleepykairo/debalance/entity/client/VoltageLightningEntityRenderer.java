...
public class VoltageLightningEntityRenderer extends EntityRenderer<VoltageLightningEntity> {
    public VoltageLightningEntityRenderer(EntityRendererFactory.Context context) {
        super(context);
    }

    public void render(VoltageLightningEntity lightningEntity, float f, float g, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i) {
        ...
        for (int l = 0; l < 4; l++) {
            ...
            for (int m = 0; m < 3; m++) {
                ...
                for (int r = n; r >= o; r--) {
                    ...
                    drawBranch(matrix4f, vertexConsumer, p, q, r, s, t, 0.25F, 0.25F, 0.8F, y, z, false, false, true, false);
                    drawBranch(matrix4f, vertexConsumer, p, q, r, s, t, 0.25F, 0.25F, 0.8F, y, z, true, false, true, true);
                    drawBranch(matrix4f, vertexConsumer, p, q, r, s, t, 0.25F, 0.25F, 0.8F, y, z, true, true, false, true);
                    drawBranch(matrix4f, vertexConsumer, p, q, r, s, t, 0.25F, 0.25F, 0.8F, y, z, false, true, false, false);
                }
            }
        }
    }
    ...
    public Identifier getTexture(VoltageLightningEntity lightningEntity) {
